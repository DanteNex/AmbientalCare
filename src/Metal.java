public class Metal extends Lixo {
	Metal() {
		...
		this.metodoReciclagem = "Uma das etapas mais importantes no processo de reciclagem de metal é a separação e coleta seletiva do metal. Nas empresas, residências e outros locais existem espaços destinados ao descarte de metal. Separação no processo de reciclagem\r\n" + 
				"\r\n" + 
				"\r\n" + 
				"\r\n" + 
